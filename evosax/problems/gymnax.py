...
class GymnaxProblem:
    ...
    def eval(self, key: jax.Array, policy_params: PyTree):
    ...
    def rollout_ffw(self, key: jax.Array, policy_params: PyTree):
    ...
    def rollout_rnn(self, key: jax.Array, policy_params: PyTree):
