...
class Sep_CMA_ES(DistributedStrategy):
    ...
    def apply_update_strategy(
        ...
        mean = jax.lax.pmean(update.mean, "device")
        p_sigma = jax.lax.pmean(update.p_sigma, "device")
        C = jax.lax.pmean(update.C, "device")
        D = jax.lax.pmean(update.D, "device")
        p_c = jax.lax.pmean(update.p_c, "device")
        sigma_scale = jax.lax.pmean(update.sigma_scale, "device")
        sigma = jax.lax.pmean(update.sigma, "device")
